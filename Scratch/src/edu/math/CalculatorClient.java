...
class CalculatorClient {
    ...
    public static void main(String[] args) {
        ...
        //below, it's okay to pass ints where double s are expected in the subtract() method
        //at runtime, an implicit upcast is down, converting the ints to doubles
        System.out.println("The difference is " + Calculator.subtract(3, 5)); //it is okay to pass an int, 32 bit whole numbers to 64 bit floating point
